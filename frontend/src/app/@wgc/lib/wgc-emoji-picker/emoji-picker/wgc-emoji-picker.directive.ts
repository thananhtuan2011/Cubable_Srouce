...
import { WGCEmojiPickerComponent, WGCIEmojiPickerPosition, WGCIEmojiData } from './wgc-emoji-picker.component';

@Unsubscriber()
@Directive({ selector: '[wgcEmojiPicker]', exportAs: 'wgcEmojiPicker' })
export class WGCEmojiPickerDirective implements OnDestroy, OnChanges {
	...
	@Input() @DefaultValue() public position: WGCIEmojiPickerPosition = 'below';
	...
	private _instance: WGCEmojiPickerComponent;
	private _overlayRef: OverlayRef;
	private _portal: ComponentPortal<WGCEmojiPickerComponent>;
	...
	ngOnChanges( changes: SimpleChanges ) {
		...
		if ( changes.perLine ) this._instance.perLine = this.perLine;
	}
	...
	/**
	 * @param {WGCIEmojiData} event
	 * @return {void}
	 */
	public onEmojiPicked( event: WGCIEmojiData ) {
	...
	public open( event?: Event ) {
		...
		this._instance.perLine = this.perLine;

		// Bind instance's methods
		this._instance.close = this.close.bind( this );
		this._instance.onPicked = this.onEmojiPicked.bind( this );
	...
	/**
	 * @return {ComponentPortal<WGCEmojiPickerComponent>}
	 */
	private _createPortal(): ComponentPortal<WGCEmojiPickerComponent> {
		return this._portal ||= new ComponentPortal( WGCEmojiPickerComponent, this._vcRef );
	}
