...
import { WGCColorPickerComponent, WGCIColorPickerPosition, WGCIColorPickerEmptyMode } from './wgc-color-picker.component';

@Unsubscriber()
@Directive({ selector: '[wgcColorPicker]', exportAs: 'wgcColorPicker' })
export class WGCColorPickerDirective implements OnDestroy, OnChanges {
	...
	@Input() @DefaultValue() public position: WGCIColorPickerPosition = 'below';
	...
	private _instance: WGCColorPickerComponent;
	private _overlayRef: OverlayRef;
	private _portal: ComponentPortal<WGCColorPickerComponent>;
	...
	ngOnChanges( changes: SimpleChanges ) {
		...
		if ( changes.pickedColor ) this._instance.pickedColor = this.pickedColor;
		if ( changes.emptyMode ) this._instance.emptyMode = this.emptyMode;
	}
	...
	public open( event?: Event ) {
		...
		this._instance.pickedColor = this.pickedColor;
		this._instance.pickedColorChange = this.pickedColorChange;
		this._instance.emptyMode = this.emptyMode;

		// Bind instance's methods
		this._instance.close = this.close.bind( this );
		this._instance.onPicked = this.onColorPicked.bind( this );
	...
	/**
	 * @return {ComponentPortal<WGCColorPickerComponent>}
	 */
	private _createPortal(): ComponentPortal<WGCColorPickerComponent> {
		return this._portal ||= new ComponentPortal( WGCColorPickerComponent, this._vcRef );
	}
