...
import {
	...
	ProgressData,
	ProgressDataCustom
} from './progress-comparison.component';

export const validateProgressCondition = (
	option: DataValidate<ProgressData>,
	validFields: Field[],
	...
	switch ( option.operator ) {
		...
		case ComparisonOperator.LESS_THAN_OR_EQUAL:
			const data: ProgressDataCustom
				= option.data as ProgressDataCustom;
		...
		case ComparisonOperator.IS_NOT_BETWEEN:
			const start: number
				= ( option.data as ProgressDataCustom ).start;
			const end: number
				= ( option.data as ProgressDataCustom ).end;
			...
			if (
				...
				validateControlFunc(
					( comp.subComparison as ProgressComparisonComponent )
					.rangeForm
					.controls
