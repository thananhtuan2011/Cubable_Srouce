...
import {
	...
	RatingData
} from './rating-comparison.component';

export const validateRatingCondition = (
	option: DataValidate<RatingData>,
	validFields: Field[],
	...
	switch ( option.operator ) {
		...
		case ComparisonOperator.IS_NOT_BETWEEN:
			...
			if ( validateControl && comp?.subComparison ) {
				validateControlFunc(
					( comp.subComparison as RatingComparisonComponent )
					.rangeForm
					.controls
