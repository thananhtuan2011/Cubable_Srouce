...
import {
	PhoneData,
	PhoneDataCustom
} from './phone-comparison.component';

export const validatePhoneCondition = (
	option: DataValidate<PhoneData>,
	validFields: Field[],
	...
	switch ( option.operator ) {
		...
		case ComparisonOperator.DOES_NOT_CONTAINS:
			const data: PhoneDataCustom
				= option.data as PhoneDataCustom;
