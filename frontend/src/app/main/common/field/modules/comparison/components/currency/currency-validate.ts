...
import {
	...
	CurrencyData
} from './currency-comparison.component';

export const validateCurrencyCondition = (
	option: DataValidate<CurrencyData>,
	validFields: Field[],
	...
	switch ( option.operator ) {
		...
		case ComparisonOperator.IS_NOT_BETWEEN: {
			...
			if (
				...
				validateControlFunc(
					( comp.subComparison as CurrencyComparisonComponent )
					.rangeForm
					.controls
