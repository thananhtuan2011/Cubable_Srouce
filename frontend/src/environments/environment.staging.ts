...
export const ENVIRONMENT = {
	...
	SERVER_API_URL					: 'https://api.workblink.com',
	SERVER_WEBSOCKET_URL			: 'https://socket.workblink.com',
	FILE_SYSTEM_API_URL				: 'https://files.workblink.com',
	APP_URL							: 'https://workblink.com',
	APP_DOMAIN						: 'workblink.com',
	APP_NAME						: 'Cubable',
