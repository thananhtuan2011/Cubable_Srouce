...
export const ENVIRONMENT = {
	...
	SERVER_API_URL					: 'https://api-beta.workgot.vn',
	SERVER_WEBSOCKET_URL			: 'https://socket-beta.workgot.vn',
	FILE_SYSTEM_API_URL				: 'https://file-beta.workgot.vn',
	APP_URL							: 'https://beta.workgot.vn',
	APP_DOMAIN						: 'beta.workgot.vn',
	APP_NAME						: 'Cubable',
